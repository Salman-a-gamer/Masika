...
const FindGynecologists = () => {
  ...
  const handleFind = async () => {
    try {
      ...
      const placesResponse = await axios.get(`https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${lat},${lng}&radius=5000&type=doctor&keyword=gynecologist&key=APIKEY`);
